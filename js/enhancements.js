...
function initThreeBackground() {
  ...
  const palette = [
    [0.957, 0.561, 0.694],  // ice pink #f48fb1
    [0.973, 0.733, 0.851],  // ice pink-2 #f8bbd9
    [0.914, 0.627, 0.753],  // soft mauve #e8a0c0
...
function initConfetti() {
  ...
  const colors = ['#f48fb1', '#fce4ec', '#e8a0c0', '#f8bbd9', '#ff80ab', '#fff0f5'];
